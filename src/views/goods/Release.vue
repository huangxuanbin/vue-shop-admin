        ...
        <el-card class="box">
            ...
            <el-form ref="form" :model="form" :rules="rules" label-position="left" label-width="120px">
                ...
                <el-form-item label="商品轮播图" prop="slider">
                    <el-upload action="/api/upload/slider" :limit="6" :headers="headers" list-type="picture-card"
                ...
                <el-form-item label="所在地" required>
                    ...
                    <el-select v-model="form.county" placeholder="请选择活动区域" class="goods-select">
...
export default {
    ...
    async mounted() {
        ...
        // 获取省
        this.province = await this.loadProvince();
        this.form.province = this.province[0].province_id;
    ...
    methods: {
        ...
        // 获取省
        async loadProvince() {
            let { status, data } = await Category.getProvince();
            return data;
        },
        // 获取市
        async loadCity(id) {
            let { status, data } = await Category.getCity({ id });
            return data;
        },
        // 获取区
        async loadCounty(id) {
            let { status, data } = await Category.getCounty({ id });
            return data;
        },
        // 轮播图
        ...
        async handleRemove(file, fileList) {
            ...
            var src = file.response.src.replace(/.+\/images/, "./images");
